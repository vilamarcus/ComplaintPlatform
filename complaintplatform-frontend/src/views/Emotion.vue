...
<template>
  <div class="app-container" :style="{  backgroundSize: 'cover', backgroundPosition: 'center' }">
    <!-- 顶部导航栏 -->
    ...
    <!-- 主内容区域 -->
    <el-container class="main-container" style="position: relative; z-index: 1;background-color: rgba(0, 0, 0, 0.5);">
      <!-- 左侧分类菜单 -->
      <el-aside width="25%" style="position: absolute;background-color: rgba(0, 0, 0, 0.5); top: 0; left: 0; bottom: 0; z-index: 2;">
        <el-menu default-active="1"  style="padding-top:150px;padding-bottom: 650px;text-align: right;background-color: transparent;font-weight: bold;padding-left: 250px">
          <el-menu-item index="1"><router-link class="menu-link" to="/treeHole">悄悄话</router-link></el-menu-item><s></s>

          <el-menu-item index="2"><router-link class="menu-link" to="/emotion">情绪日志</router-link></el-menu-item>
        </el-menu>

      </el-aside>

      <!-- 中间内容区域 -->
      <el-main style="padding: 0; position: relative; z-index: 1;">
        <div style="z-index: -1;">
          <!-- 中间区域 -->
          <div class="center-content">
            <img  style=" opacity:0.2; filter:alpha(opacity=60);" src="@/assets/tree.jpg" alt="Tree Hole Image" class="tree-hole-image" />
            <div class="overlay-text">
              <el-calendar v-model="value" style="margin-right: 100px ;margin-left: 20px;font-size: large;color:darkseagreen;font-family:幼圆,Algerian,serif;font-weight: bold"/>
      ...
      <el-col :span="8">
        <div class="user-info-card" style="background-color: #fafff6">
          ...
          <el-button type="primary" round style="width: 100%; margin-top: 20px; font-weight: bold">
